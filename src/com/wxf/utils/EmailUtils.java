...
public class EmailUtils {
	public static void sendEmail(User user){
		//发送方
		String myAccount = "wxf5816212@163.com";
		//授权码
		String myPass = "BMXZDSTZGKRRZLEK";
		//发件人 邮箱的 SMTP 服务器地址
...
//			String ip = Inet4Address.getLocalHost().getHostAddress();
			...
			String url = "http://"+ip+":8080/myshop_war_exploded/user?e="+ Base64Utils.encode(user.getUemail())+"&method=active&c="+Base64Utils.encode(user.getUcode());
			//设置邮件正文 setContent 可以使用html标签
			message.setContent(user.getUname()+",你好<br>欢迎注册小米商城! 请点击链接进行激活:<a href='"+url+"'>"+url+"</a>","text/html;charset=utf-8");
			//设置邮件的发送时间 是立即发送
