...
<script type="text/javascript">
	function sendOrder(id){
		location.href = "${pageContext.request.contextPath}/admin/admin?method=sendOrder&oid="+id;
	}
	$(function(){
		$("#search").click(function(){
			var username = $("input[name='username']").val();
			var status = $("select[name='orderStatus'] option:selected").val();
			location.href="${pageContext.request.contextPath}/admin/admin?method=searchOrder&username="+username+"&status="+status;
		})
	})
</script>
</head>
