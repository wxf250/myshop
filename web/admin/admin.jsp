		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/admin?method=getGoodsType");
				});
				...
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/admin?method=getGoodsList");
				});
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","addGoods.jsp");
				});
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/admin?method=getAllOrder");
				})
			</script>
