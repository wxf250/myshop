...
<%@ page import="com.wxf.entity.Orders" %>
	...
	<table cellpadding="0" cellspacing="0" align="center" width="100%" class="table table-striped table-bordered table-hover">
		...
		<tr>
			<td align="right" colspan="4" style="margin-right: 40px;">
				<a href="order?method=getOrderList" class="btn btn-danger btn-sm">返回订单列表</a>
				&nbsp;&nbsp;
				<c:if test="${order.ostate eq 0 }">
					<button type="button" onclick="pay('${order.oid}','${order.ocount}')" class="btn btn-warning btn-sm">易付宝支付</button>
						&nbsp;&nbsp;
